  ...
  return (
    <div className="circuit-bg relative overflow-hidden min-h-screen text-white pt-24 pb-16">
      <div className="relative z-10">
        <SEOHead 
          title="Terms and Conditions | PipFactor"
          description="Terms and Conditions for PipFactor."
          canonical="https://pipfactor.com/terms-and-conditions"
        />
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-[#1a1d21] border border-[#C8935A]/20 p-8 md:p-12 rounded-2xl shadow-xl">
            ...
            <div className="prose prose-invert max-w-none text-[#9CA3AF] space-y-6">
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">Agreement to Our Legal Terms</h2>
              <p className="mb-4">We are <strong>PipFactor</strong> ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>,"
              "<strong>our</strong>"). We operate the website <a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="https://pipfactor.com">https://pipfactor.com</a>, as
              well as any other related products and services that refer or link to these legal terms (the "<strong>Legal
              Terms</strong>") (collectively, the "<strong>Services</strong>").</p>
              <p className="mb-4">You can contact us by email at <a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="mailto:support@pipfactor.com">support@pipfactor.com</a> or by mail to
              Bengaluru, Karnataka, 560119, India.</p>
              <p className="mb-4">These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an
              entity ("<strong>you</strong>"), and PipFactor, concerning your access to and use of the Services. You agree
              that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms.
              <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE
              SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
              </p>
              <p className="mb-4">Supplemental terms and conditions or documents that may be posted on the Services from time to time are hereby
              expressly incorporated herein by reference. We reserve the right, in our sole discretion, to make changes or
              modifications to these Legal Terms <em>at any time and for any reason</em>. We will alert you about any changes
              by updating the "Last updated" date of these Legal Terms, and you waive any right to receive specific notice of
              ...
              in any revised Legal Terms by your continued use of the Services after the date such revised Legal Terms are
              posted.</p>
              ...
              <ol className="list-decimal pl-6 space-y-2 text-[#9CA3AF] mb-4">
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#services">Our Services</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#ip">Intellectual Property Rights</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#userreps">User Representations</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#prohibited">Prohibited Activities</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#ugc">User Generated Contributions</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#license">Contribution License</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#sitemanage">Services Management</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#terms">Term and Termination</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#modifications">Modifications and Interruptions</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#law">Governing Law</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#disputes">Dispute Resolution</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#corrections">Corrections</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#disclaimer">Disclaimer</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#liability">Limitations of Liability</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#indemnification">Indemnification</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#userdata">User Data</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#electronic">Electronic Communications, Transactions, and Signatures</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#misc">Miscellaneous</a></li>
              <li><a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#contact">Contact Us</a></li>
              </ol>
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">1. Our Services</h2>
              <p className="mb-4">The information provided when using the Services is not intended for distribution to or use by any person or
              ...
              <p className="mb-4">PipFactor is a SaaS platform that provides AI-powered trading signals, strategies, and financial news analysis to
              help traders make informed decisions. The platform generates insights based on market data and news feeds but
              does <strong>not</strong> function as a trading platform or execute trades on behalf of users. All content
              provided through the Services is for informational purposes only and does not constitute financial advice.</p>

              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">2. Intellectual Property Rights</h2>
              <h3 className="text-lg text-[#E2B485] mt-6 mb-3 font-semibold">Our intellectual property</h3>
              <p className="mb-4">We are the owner or the licensee of all intellectual property rights in our Services, including all source code,
              databases, functionality, software, website designs, audio, video, text, photographs, and graphics in the
              Services (collectively, the "<strong>Content</strong>"), as well as the trademarks, service marks, and logos
              contained therein (the "<strong>Marks</strong>").</p>
              <p className="mb-4">Our Content and Marks are protected by copyright and trademark laws (and various other intellectual property
              rights and unfair competition laws) and treaties in the United States and around the world.</p>
              <p className="mb-4">The Content and Marks are provided in or through the Services "<strong>AS IS</strong>" for your <strong>personal,
              non-commercial use or internal business purpose</strong> only.</p>
              <h3 className="text-lg text-[#E2B485] mt-6 mb-3 font-semibold">Your use of our Services</h3>
              <p className="mb-4">Subject to your compliance with these Legal Terms, including the "<a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#prohibited">Prohibited
              Activities</a>" section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
              <ul className="list-disc pl-6 space-y-2 text-[#9CA3AF] mb-4">
              ...
              <p className="mb-4">Except as set out in this section or elsewhere in our Legal Terms, no part of the Services and no Content or
              ...
              <p className="mb-4">If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere
              in our Legal Terms, please address your request to: <a
              href="mailto:support@pipfactor.com">support@pipfactor.com</a>. If we ever grant you the permission to post,
              ...
              <p className="mb-4">Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your
              right to use our Services will terminate immediately.</p>
              <h3 className="text-lg text-[#E2B485] mt-6 mb-3 font-semibold">Your submissions</h3>
              <p className="mb-4">Please review this section and the "<a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#prohibited">Prohibited Activities</a>" section carefully prior to
              using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload
              any content through the Services.</p>
              <p className="mb-4"><strong>Submissions:</strong> By directly sending us any question, comment, suggestion, idea, feedback, or other
              information about the Services ("<strong>Submissions</strong>"), you agree to assign to us all intellectual
              ...
              <p className="mb-4"><strong>You are responsible for what you post or upload:</strong> By sending us Submissions through any part of
              the Services you:</p>
              <ul className="list-disc pl-6 space-y-2 text-[#9CA3AF] mb-4">
                <li>confirm that you have read and agree with our "<a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="#prohibited">Prohibited Activities</a>" and will not
                ...
                your Submissions; and</li>
                <li>warrant and represent that your Submissions do not constitute confidential information.</li>
              </ul>
              <p className="mb-4">You are solely responsible for your Submissions and you expressly agree to reimburse us for any and all losses
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">3. User Representations</h2>
              ...
              <ul className="list-disc pl-6 space-y-2 text-[#9CA3AF] mb-4">
                ...
                <li>(3) you will not access the Services through automated or non-human means, whether through a bot, script or
                otherwise;</li>
              ...
              <p className="mb-4">If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to
              suspend or terminate your account and refuse any and all current or future use of the Services (or any portion
              thereof).</p>

              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">4. Prohibited Activities</h2>
              <p className="mb-4">You may not access or use the Services for any purpose other than that for which we make the Services available.
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">5. User Generated Contributions</h2>
              <p className="mb-4">The Services do not offer users the ability to submit or post content. We may provide you with the opportunity to
              create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us
              or on the Services in the future. Any such content you send us constitutes a Submission as described above.</p>

              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">6. Contribution License</h2>
              <p className="mb-4">You and the Services agree that we may access, store, process, and use any information and personal data that you
              provide following the terms of the Privacy Policy and your choices (including settings).</p>
              <p className="mb-4">By submitting suggestions or other feedback regarding the Services, you agree that we can use and share such
              feedback for any purpose without compensation to you.</p>
              <p className="mb-4">We do not assert any ownership over your Contributions. You retain full ownership of all of your Contributions
              and any intellectual property rights or other proprietary rights associated with your Contributions.</p>

              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">7. Services Management</h2>
              <p className="mb-4">We reserve the right, but not the obligation, to: (1) monitor the Services for violations of these Legal Terms;
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">8. Term and Termination</h2>
              <p className="mb-4">These Legal Terms shall remain in full force and effect while you use the Services. WITHOUT LIMITING ANY OTHER
              ...
              <p className="mb-4">If we terminate or suspend your account for any reason, you are prohibited from registering and creating a new
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">9. Modifications and Interruptions</h2>
              <p className="mb-4">We reserve the right to change, modify, or remove the contents of the Services at any time or for any reason at
              ...
              of the Services.</p>
              <p className="mb-4">We cannot guarantee the Services will be available at all times. We may experience hardware, software, or other
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">10. Governing Law</h2>
              <p className="mb-4">These Legal Terms shall be governed by and defined following the laws of <strong>India</strong>. PipFactor and
              yourself irrevocably consent that the courts of <strong>India</strong> shall have exclusive jurisdiction to
              resolve any dispute which may arise in connection with these Legal Terms.</p>

              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">11. Dispute Resolution</h2>
              <h3 className="text-lg text-[#E2B485] mt-6 mb-3 font-semibold">Informal Negotiations</h3>
              <p className="mb-4">To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms
              ...
              expressly provided below) informally for at least <strong>30 days</strong> before initiating arbitration. Such
              informal negotiations commence upon written notice from one Party to the other Party.</p>
              <h3 className="text-lg text-[#E2B485] mt-6 mb-3 font-semibold">Binding Arbitration</h3>
              <p className="mb-4">Any dispute arising out of or in connection with these Legal Terms, including any question regarding its
              existence, validity, or termination, shall be referred to and finally resolved by arbitration. The seat, or
              legal place, of arbitration shall be <strong>Bengaluru, India</strong>. The language of the proceedings shall be
              <strong>English</strong>. The governing law of these Legal Terms shall be the substantive law of
              <strong>India</strong>. Each Party shall be represented by <strong>1</strong> arbitrator.
              </p>
              <h3 className="text-lg text-[#E2B485] mt-6 mb-3 font-semibold">Restrictions</h3>
              <p className="mb-4">The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the
              ...
              <h3 className="text-lg text-[#E2B485] mt-6 mb-3 font-semibold">Exceptions to Informal Negotiations and Arbitration</h3>
              <p className="mb-4">The Parties agree that the following Disputes are not subject to the above provisions concerning informal
              ...
              agree to submit to the personal jurisdiction of that court.</p>

              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">12. Corrections</h2>
              <p className="mb-4">There may be information on the Services that contains typographical errors, inaccuracies, or omissions,
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">13. Disclaimer</h2>
              <p className="mb-4">THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF
              THE SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES,
              ...
              WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES' CONTENT OR THE CONTENT OF ANY
              WEBSITES OR MOBILE APPLICATIONS LINKED TO THE SERVICES AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY
              (1) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY
              NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS TO OR USE
              ...
              YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES.</p>
              <p className="mb-4">The trading signals, strategies, and financial news analysis provided through PipFactor are for informational
              purposes only and do not constitute financial or investment advice. You should exercise your own judgment and
              consult a qualified financial advisor before making any trading or investment decisions.</p>

              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">14. Limitations of Liability</h2>
              <p className="mb-4">IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD
              PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING
              LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE
              BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
              <p className="mb-4">NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY
              CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF THE
              AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING.</p>
              <p className="mb-4">CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">15. Indemnification</h2>
              <p className="mb-4">You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">16. User Data</h2>
              <p className="mb-4">We will maintain certain data that you transmit to the Services for the purpose of managing the performance of
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">17. Electronic Communications, Transactions, and Signatures</h2>
              <p className="mb-4">Visiting the Services, sending us emails, and completing online forms constitute electronic communications. You
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">18. Miscellaneous</h2>
              <p className="mb-4">These Legal Terms and any policies or operating rules posted by us on the Services or in respect to the Services
              ...
              <h2 className="text-xl text-[#E2B485] mt-8 mb-4 font-semibold">19. Contact Us</h2>
              <p className="mb-4">In order to resolve a complaint regarding the Services or to receive further information regarding use of the
              Services, please contact us at:</p>
              <strong>PipFactor</strong><br />
              Bengaluru, Karnataka 560119<br />
              India<br /><br />
              Email: <a className="text-[#E2B485] hover:underline" target="_blank" rel="noopener noreferrer" href="mailto:support@pipfactor.com">support@pipfactor.com</a>
            </div>
          </div>
        </div>
      </div>
