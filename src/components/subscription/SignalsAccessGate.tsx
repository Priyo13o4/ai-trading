...
interface SignalsAccessGateProps {
  ...
  /** 'fullpage' replaces the page; 'card' renders just the upgrade card for use inside a blur overlay */
...
export function SignalsAccessGate({ pageName, variant = 'fullpage' }: SignalsAccessGateProps) {
