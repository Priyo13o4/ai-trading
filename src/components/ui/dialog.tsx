...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm text-slate-400 ring-offset-background transition-all hover:text-white hover:bg-slate-700/50 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/50 focus:ring-offset-2 disabled:pointer-events-none p-1">
        <X className="h-4 w-4" />
